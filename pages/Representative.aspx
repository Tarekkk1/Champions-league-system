    ...
    <body>
                                            ...
                                            <div class="art-content-layout">
                                                <div class="art-content-layout-row">
                                                    <div class="art-layout-cell layout-item-0"
                                                        style="width: 33%; top: 0px; left: 0px; height: 262px;">
                                                        <h4>Club Information</h4>
                                                        <img width="360" height="197" alt="" class="art-lightbox"
                                                            src="images/sportsclub.jpg">
                                                    </div>
                                                    <div class="art-layout-cell layout-item-1" style="width: 34%">
                                                        <h4>Available Stadiums</h4>
                                                        <img width="360" height="196" alt="" class="art-lightbox"
                                                            src="images/match.jpg">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                        &nbsp; &nbsp; &nbsp;
                                                    </div>
                                                    <div class="art-layout-cell layout-item-2" style="width: 33%">
                                                        <h4>Hosting Request</h4>
                                                        <img width="350" height="198" alt="" class="art-lightbox"
                                                            src="images/stad.png">&nbsp; &nbsp; &nbsp;
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="art-content-layout">
                                                <div class="art-content-layout-row">
                                                    <div class="art-layout-cell layout-item-3"
                                                        style="width: 33%; top: -13px; left: 0px; height: 255px;">
                                                        <p>
                                                            <asp:Label ID="ClubInfo" runat="server" Height="200px"
                                                                Width="283px" Font-Size="Larger"></asp:Label>
                                                        </p>
        ...
        <br />
            <asp:Button ID="Mat" runat="server" CssClass="art-button" Text="View Matches"/> !-->
                                                    ...
                                                    <div class="art-layout-cell layout-item-4"
                                                        style="width: 34%; top: 0px; left: -42px; height: 261px;">
                                                        <p>
                                                            ...
                                                            <asp:TextBox ID="DT" runat="server"
                                                                TextMode="DateTimeLocal"></asp:TextBox>
                                                            <br />
                                                            <br />
                                                            <asp:Button ID="ConfirmDate" runat="server" Text="Confirm"
                                                                OnClick="stadiums" Height="35px" Width="100px"
                                                                CssClass="art-button" />

                                                        </p>
                                                    </div>
                                                    <div class="art-layout-cell layout-item-3"
                                                        style="width: 33%; top: -10px; left: 0px; height: 190px;">

                                                        <asp:TextBox ID="Host" runat="server" CssClass="art-article"
                                                            Height="12px" Width="104px" />
                                                        &nbsp; Host<br />
                                                        <br />
                                                        <asp:TextBox ID="Stadium" runat="server" CssClass="art-article"
                                                            Height="12px" Width="104px" />
                                                        &nbsp; Stadium<br />
                                                        <br />
                                                        <asp:TextBox ID="StartTime" runat="server"
                                                            CssClass="art-article" Height="12px" Width="104px" />
                                                        &nbsp; Start Time<br />
                                                        <br />
                                                        <asp:Button ID="send" runat="server" CssClass="art-button"
                                                            Text="Send" OnClick="sendRequest" Height="35px" />
                                                        <br />
                                                        <br />
                                                        <br />
                                            ...
                                            <div class="art-content-layout">
                                                ...
                                                <div class="art-content-layout-row">
                                                    ...
                                                    <div class="art-layout-cell layout-item-4"
                                                        style="width: 68%; top: 0px; left: 0px; height: 285px;">
                                                        ...
                                                        <span style="color:rgb(108, 172, 224);">
                                                            ...
                                                            <asp:Label ID="any" runat="server"
                                                                Text="Host   Guest    Start     End     Stadium"
                                                                Font-Size="Larger" Font-Bold="true" Font-Italic="true">
                                                            </asp:Label>
                                                            <br />
                                                            <asp:Label ID="upcomingMatches" runat="server"
                                                                Height="257px" Width="294px"></asp:Label>
                                                    ...
                                                    <div class="art-layout-cell layout-item-3"
                                                        style="width: 32%; top: 0px; left: 0px; height: 302px;">
                                                        <h1>Stadiums</h1>
                                                        <p><span style="color:rgb(108, 172, 224);">

                                                                <!--label for available stadiums!-->
                                                                <br />
                                                                <asp:Label ID="any2" runat="server"
                                                                    Text="Name    Location   Capacity"
                        ...
                        <div class="art-content-layout-wrapper layout-item-0">
                            <div class="art-content-layout layout-item-1">
                                <div class="art-content-layout-row">
                                    ...
                                    <div class="art-layout-cell layout-item-2" style="width: 50%">
                                        <p style="text-align: right;"><a href="#">Privacy
                                                Policy</a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="#">Terms Of
                                                Use</a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="#">About</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
